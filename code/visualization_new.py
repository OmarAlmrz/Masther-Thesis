...
def main():
    ...
    user = 'adam'
    p = os.path.join(r'data\processed_30hz_relabeled', user)
...
if __name__ == '__main__':
    #main()
    filepath = r"data Omar\pixel\16_06_24\Breaststroke1718557134866.csv"
    plot_raw_recording(file_path=filepath)
