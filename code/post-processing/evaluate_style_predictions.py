...
loso_path = r'.\results\with_class_4\7' #Path where trained LOSO models are stored
save_path = 'SAVE_PATH'
...
print(utils.write_confusion_matrix_expanded(expanded_matrix, labels=[1, 2, 3, 4, 0]))
